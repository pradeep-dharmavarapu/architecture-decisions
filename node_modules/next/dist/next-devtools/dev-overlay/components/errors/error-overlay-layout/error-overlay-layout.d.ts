...
export declare function ErrorOverlayLayout({ errorMessage, errorType, children, headerChildren, errorCode, errorCount: _errorCount, error, debugInfo, isBuildError, onClose, versionInfo, runtimeErrors, activeIdx, setActiveIndex, dialogResizerRef, generateErrorInfo, rendered, transitionDurationMs, }: ErrorOverlayLayoutProps): import("react/jsx-runtime").JSX.Element;

...
async function exportPageImpl(input, fileWriter) {
    ...
    if (isAppDir && (0, _isapprouteroute.isAppRouteRoute)(page)) {
        return (0, _approute.exportAppRoute)(req, res, params, page, components.routeModule, commonRenderOpts.incrementalCache, commonRenderOpts.cacheLifeProfiles, htmlFilepath, fileWriter, commonRenderOpts.cacheComponents, commonRenderOpts.staticPageGenerationTimeout, commonRenderOpts.experimental, buildId, deploymentId);
    }
    const renderOpts = {
        ...components,
        ...commonRenderOpts,

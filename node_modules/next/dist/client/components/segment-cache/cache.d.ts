...
export declare function fetchSegmentsOnCacheMiss(route: FulfilledRouteCacheEntry, routeKey: RouteCacheKey, tree: RouteTree, segments: SegmentBundle, segmentCount: number): Promise<PrefetchSubtaskResult<null> | null>;

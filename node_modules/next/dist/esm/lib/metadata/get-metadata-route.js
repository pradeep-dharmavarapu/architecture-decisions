...
function getStaticMetadataRoute(segment) {
    ...
    return normalizePathSep(path.join('/', ...pathname.split('/').filter(Boolean).map((pathnameSegment)=>normalizeStaticMetadataRouteSegment(pathnameSegment))));
}
export function fillStaticMetadataSegment(segment, lastSegment) {
    return normalizePathSep(path.join(getStaticMetadataRoute(segment), getMetadataRouteFilename(segment, lastSegment)));
}
/**
 ...
 */ export function fillMetadataSegment(segment, params, lastSegment, isStatic) {
    ...
    return normalizePathSep(path.join(route, getMetadataRouteFilename(segment, lastSegment)));
}
/**

...
export async function writeAppTypeDeclarations({ baseDir, distDir, imageImportsEnabled, hasPagesDir, hasAppDir, strictRouteTypes, typedRoutes, rootParams }) {
   ...
   */ const lines = [
    ...
    if (rootParams) {
        const rootParamsTypesPath = path.posix.join(distDir.replaceAll(path.win32.sep, path.posix.sep), 'types/root-params.d.ts');

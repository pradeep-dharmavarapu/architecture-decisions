...
import { getSource, isPositionInsideNode, getTs, removeStringQuotes, getTypeChecker } from '../utils';
    ...
    getQuickInfoAtPosition (fileName, position) {
        ...
        visitEntryConfig(fileName, position, (entryConfig, declaration)=>{
            ...
            if (value && !isFunctionValue && isPositionInsideNode(position, value)) {
                ...
                if (isFunctionValue && isPositionInsideNode(position, value) && // hover is somewhere within the function initializer

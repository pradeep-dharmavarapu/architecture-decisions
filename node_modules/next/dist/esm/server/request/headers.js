...
import { throwForMissingRequestStore, workUnitAsyncStorage, isInEarlyRenderStage } from '../app-render/work-unit-async-storage.external';
...
import { delayUntilRuntimeStage, makeDevtoolsIOAwarePromise, makeHangingPromise } from '../dynamic-rendering-utils';
            ...
            switch(workUnitStore.type){
                ...
                case 'request':
                    ...
                    if (process.env.NODE_ENV === 'development') {
                        ...
                        return isInEarlyRenderStage(workUnitStore) ? workUnitStore.asyncApiPromises.earlyHeaders : workUnitStore.asyncApiPromises.headers;
                    } else {
                        return makeUntrackedHeaders(workUnitStore.headers);
                    }
                    break;
...
function makeUntrackedHeadersWithDevWarnings(underlyingHeaders, route, requestStore) {
    if (requestStore.asyncApiPromises) {
        const promise = isInEarlyRenderStage(requestStore) ? requestStore.asyncApiPromises.earlyHeaders : requestStore.asyncApiPromises.headers;

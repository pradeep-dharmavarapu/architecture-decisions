        ...
        try {
            ...
            const handleResponse = async (span)=>{
                ...
                if (!result.value) {
                    ...
                    addRequestMeta(req, 'notFoundRevalidate', (_result_cacheControl = result.cacheControl) == null ? void 0 : _result_cacheControl.revalidate);
                    res.statusCode = 404;
                ...
                await sendRenderResult({
                    ...
                    // anymore
                    result: isNextDataRequest && !isErrorPage && !is500Page ? new RenderResult(JSON.stringify(result.value.pageData), {

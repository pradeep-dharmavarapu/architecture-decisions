...
import { createSyncIOClientError, createSyncIOError, createSyncIORuntimeError } from '../app-render/sync-io-messages';
        ...
        case 'prerender-runtime':
            {
                ...
                if (prerenderSignal.aborted === false) {
                    ...
                    abortOnSynchronousPlatformIOAccess(workStore.route, expression, applyOwnerStack(createSyncIOError(workStore.route, expression, type)), workUnitStore);
                }
                break;
            }
        case 'prerender-client':
            {
                ...
                if (prerenderSignal.aborted === false) {
                    // If the prerender signal is already aborted we don't need to construct
                    // any stacks because something else actually terminated the prerender.
                    abortOnSynchronousPlatformIOAccess(workStore.route, expression, applyOwnerStack(createSyncIOClientError(workStore.route, expression, type)), workUnitStore);
                }
                break;
            }
        case 'request':
            {
                ...
                if (stageController && stageController.shouldTrackSyncInterrupt()) {
                    ...
                    if (stageController.currentStage === RenderStage.Static || stageController.currentStage === RenderStage.EarlyStatic) {
                        ...
                        syncIOError = createSyncIORuntimeError(workStore.route, expression, type);
                    }

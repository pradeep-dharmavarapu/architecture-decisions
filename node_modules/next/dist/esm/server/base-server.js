...
export default class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.renderOpts = {
            ...
            validationLevel: this.nextConfig.experimental.instantInsights.validationLevel,
            experimental: {
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && isAppPageRouteModule(routeModule);
        ...
        const hasInstantTestCookie = exposeTestingApi && !isRSCRequestHeader(req.headers[RSC_HEADER]) && typeof req.headers.cookie === 'string' && req.headers.cookie.includes(NEXT_INSTANT_TEST_COOKIE + '=') && couldSupportPPR;

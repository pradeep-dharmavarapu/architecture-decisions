...
export class ReactServerResult {
    ...
    tee() {
        ...
        if (process.env.NEXT_RUNTIME === 'edge') {
            throw Object.defineProperty(new InvariantError('Node.js Readable cannot be teed in the edge runtime'), "__NEXT_ERROR_CODE", {
                value: "E1149",
                enumerable: false,
                configurable: true
            });
 ...
 */ export class ReplayableNodeStream {
   ...
   */ createReplayStream() {
        if (this._chunks === null) {
            throw Object.defineProperty(new InvariantError('Cannot create a replay stream after the ReplayableNodeStream has been disposed.'), "__NEXT_ERROR_CODE", {
                value: "E1156",
                enumerable: false,
                configurable: true
            });

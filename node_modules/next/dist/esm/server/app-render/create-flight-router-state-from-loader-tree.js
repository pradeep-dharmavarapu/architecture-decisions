...
async function createFlightRouterStateFromLoaderTreeImpl(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams, didFindRootLayout) {
    ...
    const prefetchConfig = mod ? mod.unstable_prefetch : undefined;
    let prefetchHints = 0;
    ...
    for(const parallelRouteKey in parallelRoutes){
        ...
        const child = await createFlightRouterStateFromLoaderTreeImpl(parallelRoutes[parallelRouteKey], childHintNode, prefetchInliningEnabled, cacheComponents, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams, didFindRootLayout);
        // Propagate subtree flags from children
        if (child[4] !== undefined) {
            prefetchHints |= child[4] & (PrefetchHint.SubtreeHasInstant | PrefetchHint.SubtreeHasLoadingBoundary | PrefetchHint.SubtreeHasRuntimePrefetch);
            ...
            if (child[4] & (PrefetchHint.HasRuntimePrefetch | PrefetchHint.SubtreeHasRuntimePrefetch)) {
...
export async function createFlightRouterStateFromLoaderTree(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams) {
    const didFindRootLayout = false;
    return createFlightRouterStateFromLoaderTreeImpl(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams, didFindRootLayout);
}
export async function createRouteTreePrefetch(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment) {

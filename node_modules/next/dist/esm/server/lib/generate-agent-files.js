 ...
 */ export function hasAgentRulesInstalled(dir) {
    const agentsContent = tryReadFile(path.join(dir, 'AGENTS.md'));
    if (agentsContent == null ? void 0 : agentsContent.includes(AGENT_RULES_START_MARKER)) return true;
    const claudeContent = tryReadFile(path.join(dir, 'CLAUDE.md'));
    if (claudeContent == null ? void 0 : claudeContent.includes(AGENT_RULES_START_MARKER)) return true;
    return false;
}
/**
 ...
 */ export function writeAgentFiles(projectDir) {

        ...
        async function handleRoute(route) {
            ...
            if (params) {
                    ...
                    if ((_fsChecker_getMiddlewareMatchers = fsChecker.getMiddlewareMatchers()) == null ? void 0 : _fsChecker_getMiddlewareMatchers.length) {
                        ...
                        if (config.i18n) {
                            ...
                            if (curLocaleResult.detectedLocale) {
                                ...
                                normalized = addPathPrefix(curLocaleResult.pathname === '/' ? `/${defaultLocale}` : addPathPrefix(curLocaleResult.pathname || '', `/${defaultLocale}`));
                            }
                        }
                ...
                if (route.destination) {
                    ...
                    if (isRSCRequestHeader(req.headers[RSC_HEADER]) && (!parsedDestination.origin || isAllowedOrigin)) {

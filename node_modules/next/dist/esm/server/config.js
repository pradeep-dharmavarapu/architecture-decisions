 ...
 */ function finalizeConfig(config) {
    var _config_experimental_instantInsights;
    config.experimental.instantInsights = {
        validationLevel: ((_config_experimental_instantInsights = config.experimental.instantInsights) == null ? void 0 : _config_experimental_instantInsights.validationLevel) ?? 'manual-warning'
    };
    return config;
}
...
export default async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, reportExperimentalFeatures, reactProductionProfiling, debugPrerender, bundler } = {}) {
    ...
    if (path == null ? void 0 : path.length) {
        ...
        const finalConfig = finalizeConfig(await applyModifyConfig(completeConfig, phase, silent));

...
import { stripIsPartialByte, createNonTaskyPrefetchResponseStream } from '../segment-cache/cache';
 ...
 */ export async function decodeStaticStage(responseBodyClone, staticStageByteLengthPromise, headers) {
    ...
    const { stream } = await createNonTaskyPrefetchResponseStream(responseBodyClone, staticStageByteLength);

        ...
        case 1:
            {
                ...
                writeToBFCache(now, tree.varyPath, rsc, prefetchRsc, head, prefetchHead, dynamicStaleAt, bfcacheId);
                if (isPage && metadataVaryPath !== null) {
                    writeHeadToBFCache(now, metadataVaryPath, head, prefetchHead, dynamicStaleAt, bfcacheId);
                }
                return {
...
function compareSegments(newSegment, oldSegment) {
    ...
    if (typeof newSegment === 'string' && typeof oldSegment === 'string' && newSegment.startsWith(PAGE_SEGMENT_KEY) && oldSegment.startsWith(PAGE_SEGMENT_KEY)) {
        return 2;
    }
    return 1;
}

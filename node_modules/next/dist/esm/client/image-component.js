...
import React, { useRef, useEffect, useContext, useMemo, useState, forwardRef, use, useLayoutEffect } from 'react';
...
const ImageElement = /*#__PURE__*/ forwardRef(({ src, srcSet, sizes, height, width, decoding, className, style, fetchPriority, placeholder, loading, unoptimized, fill, onLoadRef, onLoadingCompleteRef, setBlurComplete, setShowAltText, sizesInput, onLoad, onError, ...rest }, forwardedRef)=>{
    ...
    return(// If you move this element creation, also move the Layout Effect above
 ...
 */ export const Image = /*#__PURE__*/ forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            ...
            imgMeta.preload ? /*#__PURE__*/ _jsx(ImagePreload, {

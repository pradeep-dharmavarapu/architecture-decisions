    ...
    if (cacheContext.kind === 'private') {
        ...
        switch(cacheContext.outerWorkUnitStore.type){
            case 'cache':
                ...
                if (cacheContext.dynamicNestedCacheError !== undefined && (metadata.revalidate === 0 || metadata.expire < _constants.DYNAMIC_EXPIRE)) {
            ...
            if (process.env.__NEXT_DEV_SERVER && outerWorkUnitStore.cacheSignal) {
                ...
                if ((stagedRendering == null ? void 0 : stagedRendering.currentStage) !== _stagedrendering.RenderStage.Dynamic) {
                    ...
                    stream = (0, _server.renderToReadableStream)(resultPromise, clientReferenceManifest.clientModules, {
                        ...
                        temporaryReferences,
                        onError (error) {
                            if (devRenderAbortController.signal.aborted && devRenderAbortController.signal.reason === error) {
                                return undefined;
                            }
                            return handleError(error);
                        }
...
async function cache(kind, id, boundArgsLength, originalFn, args) {
    ...
    if (!isPrivate && workStore.useCacheProbeMode === undefined) {
        cacheHandler = (0, _handlers.getCacheHandler)(kind);
        if (!cacheHandler) {

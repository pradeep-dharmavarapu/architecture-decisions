...
function createRequestStore(inputs) {
    const { phase, headers, onUpdateCookies, url, rootParams, implicitTags, renderResumeDataCache, previewProps, isHmrRefresh, serverComponentsHmrCache, fallbackParams } = inputs;
    const cache = {};
    return {
        type: 'request',
        phase,

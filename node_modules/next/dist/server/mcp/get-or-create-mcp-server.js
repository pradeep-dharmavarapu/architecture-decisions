...
const _getcompilationissues = require("./tools/get-compilation-issues");
let mcpServer;
const getOrCreateMcpServer = (options)=>{
    ...
    if (options.getTurbopackProject) {
        (0, _getcompilationissues.registerGetCompilationIssuesTool)(mcpServer, options.getTurbopackProject);
    }
    return mcpServer;
};

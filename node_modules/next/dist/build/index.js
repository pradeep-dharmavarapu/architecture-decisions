...
async function build(dir, experimentalAnalyze = false, reactProductionProfiling = false, debugOutput = false, debugPrerender = false, noMangling = false, appDirOnly = false, bundler = _bundler.Bundler.Turbopack, experimentalBuildMode, traceUploadUrl, debugBuildPaths, enabledFeatures = {}) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("16.3.0-canary.21");
            ...
            if (!isGenerateMode) {
                if (bundler === _bundler.Bundler.Turbopack) {
                    const { duration: compilerDuration, shutdownPromise: p, ...rest } = await (0, _turbopackbuild.turbopackBuild)(process.env.NEXT_TURBOPACK_USE_WORKER === undefined || process.env.NEXT_TURBOPACK_USE_WORKER !== '0', telemetry);
                    shutdownPromise = p;

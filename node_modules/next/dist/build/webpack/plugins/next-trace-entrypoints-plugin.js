            ...
            await finishModulesSpan.traceAsyncFn(async ()=>{
                ...
                await finishModulesSpan.traceChild('get-entries').traceAsyncFn(async ()=>{
                    for (const [name, entry] of compilation.entries.entries()){
                        ...
                        const isMiddleware = (0, _utils.isMiddlewareFilename)(normalizedName);
                            ...
                            for (const dep of entry.dependencies){
                                ...
                                if (entryMod && entryMod.resource === '') {
                                    ...
                                    if (moduleBuildInfo.route) {
                                        ...
                                        const absolutePath = isMiddleware ? moduleBuildInfo.route.absolutePagePath : (0, _entries.getPageFilePath)({
                                        ...
                                        if (isMiddleware || this.pagesDir && absolutePath.startsWith(this.pagesDir) || this.appDir && absolutePath.startsWith(this.appDir)) {

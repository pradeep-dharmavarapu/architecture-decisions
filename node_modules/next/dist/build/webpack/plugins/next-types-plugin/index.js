...
class NextTypesPlugin {
    ...
    collectPage(filePath) {
        ...
        let route = (isApp ? _apppaths.normalizeAppPath : _denormalizepagepath.denormalizePagePath)((0, _ensureleadingslash.ensureLeadingSlash)((0, _routediscovery.getPageFromPath)(_path.default.relative(isApp ? this.appDir : this.pagesDir, filePath), this.pageExtensions)));
    ...
    apply(compiler) {
        ...
        const handleModule = async (mod, compilation)=>{
            ...
            if (IS_LAYOUT) {
                const rootLayoutPath = (0, _apppaths.normalizeAppPath)((0, _ensureleadingslash.ensureLeadingSlash)((0, _routediscovery.getPageFromPath)(_path.default.relative(this.appDir, mod.resource), this.pageExtensions)));

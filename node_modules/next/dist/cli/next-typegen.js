...
const nextTypegen = async (_options, directory)=>{
    ...
    await (0, _verifytypescriptsetup.verifyAndRunTypeScript)({
        ...
        rootParams: !!nextConfig.experimental.rootParams || !!nextConfig.cacheComponents
    });
    ...
    await (0, _rootparamstypeutils.writeRootParamsTypes)(routeTypesManifest, (0, _path.join)(distDir, 'types', 'root-params.d.ts'), nextConfig);
